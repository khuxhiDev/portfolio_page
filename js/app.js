...
function getCurrentTheme(){
  ...
  let theme = 'dark';
  // Check if a theme is stored in localStorage and use it, otherwise the default remains 'dark'
...
function loadTheme(theme){
  ...
  if(theme === "light"){
    themeBtn.innerHTML = `<em></em><i class="fa-solid fa-circle-half-stroke"></i>`;
  } else {
    themeBtn.innerHTML = `<em></em><i class=fa-solid fa-circle-half-stroke"></i>`;
  }
